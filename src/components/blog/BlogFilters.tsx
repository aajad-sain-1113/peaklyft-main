...
//   return (
//     <div className="w-full px-4 sm:px-10 py-10 flex flex-col sm:flex-row items-center gap-6">
//       <p className="font-semibold text-[22px] whitespace-nowrap">Filter By:</p>
