...
return (
    <section className="container py-20 text-black rounded-[25px]">
      ...
      <div className="container text-center flex flex-col items-center justify-center rounded-[25px] py-12 px-6" style={{background:"radial-gradient(at center center, #4E5FF5 0%, #101D96 100%)"}}>

        <div className="flex items-center justify-center gap-0 mb-14 w-full max-w-5xl">
          ...
          <div
            ...
            onClick={() => setActive(0)}
          >
            <img src={methodologyData[0].icon} className="w-10 h-10 mb-2" />
          ...
          <div
            ...
            onClick={() => setActive(1)}
          >
            <img src={methodologyData[1].icon} className="w-12 h-12 mb-2" />
          ...
          <div
            ...
            onClick={() => setActive(2)}
          >
            <img src={methodologyData[2].icon} className="w-10 h-10 mb-2" />
        ...
        <div className="max-w-3xl mx-auto p-8 bg-[#FFFFFF08]">
          <h3 className="text-[20px] font-semibold mb-4 text-white font-inter">
            {methodologyData[active].heading}
          </h3>
          <p className="text-white text-base leading-[28.8px]">
