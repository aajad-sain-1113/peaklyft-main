...
export type Expert = {
  ...
  profile?: string; // LinkedIn url (optional)
};
...
<article key={d.id} className="relative my-5">
  ...
  <div className="group transition-transform duration-300 hover:-translate-y-4 relative">
    ...
    {/* CARD */}
    <div className="rounded-2xl bg-indigo-500/95 p-0 pt-14 pb-6 
      shadow-[0_8px_0_rgba(74,70,255,0.95)]">
