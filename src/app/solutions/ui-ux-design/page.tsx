...
import { salesAcademyTab4, salesAcademyTabs } from "@/utils/academyTabsData";
import { expertsData } from "@/utils/expertsData";

import { brandSections, customerSections, heroSections, uiSections } from "@/utils/Hero";
import {
  onboardingSection,
  ...
  return (
    <>
      <div className="px-2.5">  
        <Hero
          heroData={uiSections["sales-academy"]}
